...
{
 // if(q==0)return cos(x)/(1.0+aa *(1.0 - p1*cos(x)/2.0-p2*sin(x)/2.0+pow( p1*cos(x)+p2*sin(x) ,2.0)/8.0)); 
  //if(q==0)return cos(x)/(1.0+aa *(1.0 - p1*cos(x)/2.0-p2*sin(x)/2.0)); 
  if(q==0) return cos(x)/(1.0+aa *exp(-p1*cos(x)/2.0 -p2*sin(x)/2.0  ));
  //if(q==1)return sin(x)/(1.0+aa *(1.0 - p1*cos(x)/2.0-p2*sin(x)/2.0+pow( p1*cos(x)+p2*sin(x) ,2.0)/8.0)); 
...
/*double sncos2(double x,double p1,double p2,int g)
{ 
 double first = 0.0, second = 0.0;
 if(g==0)
 {
  first = pow(cos(x),2.0)/(1.0+aa *(1.0 - p1*cos(x)/2.0-p2*sin(x)/2.0+pow( p1*cos(x)+p2*sin(x) ,2.0)/8.0));
   second= pow(cos(x)/(1.0+aa *(1.0 - p1*cos(x)-p2*sin(x)+pow( p1*cos(x)+p2*sin(x) ,2.0)/2.0)),2.0);
 }
 if(g==1)
{ 
  first= pow(sin(x),2.0)/(1.0+aa *(1.0 - p1*cos(x)/2.0-p2*sin(x)/2.0+pow( p1*cos(x)+p2*sin(x) ,2.0)/8.0));
   second= pow(sin(x)/(1.0+aa *(1.0 - p1*cos(x)-p2*sin(x)+pow( p1*cos(x)+p2*sin(x) ,2.0)/2.0)),2.0);
 }
 return (first-second);
}*/
double first(double x,double p1, double p2,int g)
{
// if(g==0) return (pow(cos(x),2.0)/(1.0+aa *(1.0 - p1*cos(x)/2.0-p2*sin(x)/2.0+pow( p1*cos(x)+p2*sin(x) ,2.0)/8.0)));
...
double second(double x,double p1, double p2,int g)
{
 ...
 if(g==1) return pow(sin(x)/(1.0+aa *exp(-p1*cos(x)/2.0 -p2*sin(x)/2.0)),2.0);     
  /* double sum=  pow(cos(x),2.0);
   double under =(1.0+2.0*aa*(1.0 - p1*cos(x)/2.0-p2*sin(x)/2.0+pow( p1*cos(x)+p2*sin(x) ,2.0)/8.0));
   under+=aa*aa*(1.0 - p1*cos(x)-p2*sin(x)+pow( p1*cos(x)+p2*sin(x) ,2.0)/2.0) ;
   return sum/under;*/
 }
...
//   ans = pow(dsncos[j],2.0)/sncos2[GG(j,0)]+pow(dsncos2[j]/sncos2[GG(j,0)],2.0)/2.0;
...
//     ans = sncos2[GG(j,0)];
//     fprintf(fp,"%.15lf %.15lf %.15lf %.15lf %.15lf\n",lower+j*h,sncos[GG(j,0)],dsncos[j],sncos2[GG(j,0)],1/ans);
  // fprintf(fp,"%.15lf %.15lf %.15lf %.15lf %.15lf\n",lower+j*h,sncos[GG(j,0)],snsin[GG(j,0)],sncos2[GG(j,0)],snsin2[GG(j,0)]);
